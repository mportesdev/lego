...
class TestBrowserUI(LiveServerTestCase):
    ...
    def test_add_set(self):
        ...
        self.driver.find_element(By.XPATH, "//a[text()='102']")
        self.driver.find_element(By.XPATH, "//div[text()='Plate 1 x 3']")
        self.driver.find_element(By.XPATH, "//div[text()='White']")
        self.driver.find_element(By.XPATH, "//img[@src='img102W2.jpg']")
